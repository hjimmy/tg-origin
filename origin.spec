...
%{!?os_git_vars:
%global os_git_vars OS_GIT_MINOR=11+ OS_GIT_MAJOR=3 OS_GIT_VERSION=v3.11.0+62803d0-1 OS_GIT_TREE_STATE=clean KUBE_GIT_VERSION=v1.11.0+d4cacc0 OS_GIT_PATCH=0 KUBE_GIT_COMMIT=d4cacc0 KUBE_GIT_MINOR=11+ OS_GIT_COMMIT=62803d0 KUBE_GIT_MAJOR=1 ETCD_GIT_VERSION=v3.2.16-0-g121edf0 ETCD_GIT_COMMIT=121edf0
}
...
Source0: origin-git-0.62803d0.tar.gz
...
%prep
%if 0%{do_prep}
%setup -q -n origin-git-0.62803d0
%endif
